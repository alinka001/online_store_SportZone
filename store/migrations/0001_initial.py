    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='store.TaggedItem', to='store.ItemTag', verbose_name='Категории')),
            ],
            options={
                'verbose_name': 'Товар',
                'verbose_name_plural': 'Товары',
                'ordering': ['-price'],
                'indexes': [models.Index(fields=['title'], name='store_item_title_ece713_idx')],
            },
        ),
    ]
